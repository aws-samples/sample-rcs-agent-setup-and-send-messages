...
├── rcs-blog-post.md                   # Step-by-step technical walkthrough
...
Follow the step-by-step instructions in [rcs-blog-post.md](rcs-blog-post.md), which covers:
...
See the [Troubleshooting section](rcs-blog-post.md#troubleshooting) in the blog post for common errors and fixes.
