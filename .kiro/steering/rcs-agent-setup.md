...
| `agentDetails.accentColor` | TEXT | REQUIRED | 7 chars, `^#[0-9A-Fa-f]{6}$`, must have 4.5:1 contrast ratio vs white (WCAG AA). Light/pastel colors are rejected. |
...
| `agentDetails.monthlyRcsVolume` | TEXT | REQUIRED | 1–6 chars, `^[1-9][0-9]{0,5}$` |
